package org.example.decisionengine.exception;

import org.example.decisionengine.constant.HttpResponseConstants;
import org.example.decisionengine.error.ConstraintsViolationError;
...
public class GlobalExceptionHandler extends DefaultErrorAttributes {
	...
	protected ResponseEntity<Map<String, Object>> ofType(WebRequest request, HttpStatus status, LoanException ex) {
